...
Achilles_var_Ares_Module_Zeus_Dust = true;
...
Achilles_var_cwr3_faction_civ = true;
Achilles_var_cwr3_faction_fia = true;
Achilles_var_cwr3_faction_rus = true;
Achilles_var_cwr3_faction_uk = true;
Achilles_var_cwr3_faction_usa = true;
Achilles_var_cwr3_faction_usmc = true;
Achilles_var_cwr3_faction_vdv = true;
Achilles_var_cwr3_faction_vmf = true;
...
Achilles_var_O_PalestinPalestinianArmedForces = true;
Achilles_var_O_RedSurv = true;
Achilles_var_O_USSRMotorisedForce = true;
...
zen_faction_filter_0_O_PalestinPalestinianArmedForces = true;
zen_faction_filter_0_O_RedSurv = true;
zen_faction_filter_0_O_USSRMotorisedForce = true;
...
zen_faction_filter_1_B_IsraelCAHAL = true;
zen_faction_filter_1_B_IsraelCAHAL_groups = true;
zen_faction_filter_1_B_IsraelRegularArmy = true;
zen_faction_filter_1_B_IsraelRegularArmy_groups = true;
